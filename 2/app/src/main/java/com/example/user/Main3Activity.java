...
public class Main3Activity extends AppCompatActivity{
        ...
        if(level!=0 && check())
        {
            ...
            if(action==MotionEvent.ACTION_DOWN && x>=40 && x<1040 && y>=0 && y<1000)
            {
                if(a[y/125][(x - 40)/125]==0)
                {
                    ...
                    showToast("不能下在這裡!");
                //Toast.makeText(Main3Activity.this, "不能下在這裡!", Toast.LENGTH_SHORT).show();
            }
    ...
    public void winner(int black , int white)
    {
        if(black>white)
            showToast("Black WIN!");
        //Toast.makeText(Main3Activity.this, "Black WIN!", Toast.LENGTH_SHORT).show();
        if(black<white)
            showToast("White WIN!");
        //Toast.makeText(Main3Activity.this, "White WIN!", Toast.LENGTH_SHORT).show();
        if(black==white)
            showToast("DUEL!");
        //Toast.makeText(Main3Activity.this, "DUEL!", Toast.LENGTH_SHORT).show();
    }

    public void nowhere()
    {
        showToast("無地方下!換人");
        //Toast.makeText(Main3Activity.this, "無地方下!換人", Toast.LENGTH_SHORT).show();
    }
